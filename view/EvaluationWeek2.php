    ...
    <body>
        <div class="container">
            ...
            <div class="well">
                ...
                <p>In the websites current state this database design is efficient at storing and recieving data. As the website get updated with mmore features in the future this design will need to be reviewed and updated. This can include more entities or having relationships between entities change where necessary. As the site grows in scope, the number of tables, entities, attributes and relationships will grow too. </p>
            ...
            <div class="well">
                ...
                <div class="row">
                    <div class='col-xs-12'>
                        ...
                        <p>In the PHP a connection to the database is established first. A query on the database is then used to attain the elements from the <i>Articles</i> Table. If a result is returned that is greater than 0, then whilst the query recieves results it will print out data to the page. Inside a while loop the HTMl that creates the summaries of each article is echoed. If a date isnt selected (i.e if the date filter is left blank) then all of the articles are selected and are echoed on to the webpage.</p>
                    </div>
                </div>
            </div>
        </div>

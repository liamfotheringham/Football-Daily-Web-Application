    ...
    <body>
        <div class="container">
            ...
            <div class="well">
                ...
                <p>A framework allows developers to create a functional responsive web design faster and easier. But also, to help improve accessibility and graceful degradation of the website’s/application’s design onto smaller screens such as that on a tablet or mobile device (aka mobile-first websites). This is mostly done using HTML, CSS and jQuery.</p>

                <p> The grid-system is at the heart of any framework, as it is this that helps mostly to make a website mobile-first. In <b>Bootstrap</b>, the grid system allows up to 12 columns across a webpage. Columns can be grouped together to create a wider column. These columns will re-arrange automatically depending on the size of the device’s screen size. The use of classes is also implemented to help create a more dynamic and flexible layout for webpages.</p>

                <p> Like Bootstrap, <b>Foundation</b> has its own, implementable, grid system. In its current state, it uses the XY Grid, which allows for up to 12 independent columns like Bootstrap, but also allows for customisation of the grid margin, padding, frame and margin elements. This gives a developer greater control on how the grids will react on their webpage, thus giving a responsive and well thought out design.</p>
            </div>
            <div class="well">
                <h3><b>Question 2.</b> Menu systems are often a bind to get right especially if you want a multi-dropdown menu. In an ideal world you should write the HTML for a menu as a set of hierarchical un-numbered lists. Using this as your HTML, see how your chosen framework renders this. Critisise the implementation of Menus in your chosen HTML5 framework.</h3>
                ...
                <p>The customisation options also available for the Nav element is limitless, as all components and utilities of the navbar can be customised in a CSS style sheet, making it fit into any type of application, without looking out of place.</p>
            ...
            <div class="well">
                ...
                <ol>
                    ...
                    <br>
                    <li><b>Panels:</b> The panel creatres a bordered box with padding around the contents held within it, The panels also come with conextual classes. These paels can help highlight information and when combined with a contextual class, it can give a better inital perception to a user that on what that infoprmation contains, such as a process being successful, incorrect information being entered, etc. Examples can be seen below:</li>
                    <div class="row">
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <div class="panel panel-success">
                                <div class="panel-heading">Sucess Panel</div>
                    ...
                    <br>
                    <li><b>Media Objects:</b> This provides an easy way to align and display media objects such as imges or videos, to the left or right of a page. In implementation, Twitter use this feature to display tweets on their website. This is useful as it enables developers to neatly nest a comments on a webpage, such as the one that will be built for CMP306.
                    </li>
                    <br>
                    <li><b>Glyphicon:</b> Glyphicons are icons that can be used in text, buttons, toolbars, navigation, forms, etc. They can emphasise what the function of the highlighted feature is, or even replace text within a feature if appropriate. As an example, using a magnifying glass icon instead of "Search" in a search box. It will look simpiler and more aesthetically pleasing and would reduce the clutter on a users screen. Examples can be seen below:</li>
                    <div class="row">
                        <div class="col-sm-3">
                    ...
                    <br>
                    <li><b>Responsive Images:</b> Using the <b>.img-responsive</b> class in an image tag will allow images to scale to its parent element. This is a useful element as it allows images to nicely scale and adjust to different screen sizes and devices, enabling greater accessability and usability.
                        <br>
                        Small Image:
